...
TEMPLATE_TEST_CASE("Bit mask test - compile time", "[Bit operation]", int16_t, int32_t, int64_t,
...
TEMPLATE_TEST_CASE("Set bit", "[Bit operation]", int16_t, int32_t, int64_t, size_t, uint16_t,
                   uint32_t, uint64_t) {
  // 1011 0111 1010 1011
  ...
  ByteUtilities::SetBit(nValue, (sizeof(TestType) * 8) - 1, 1);
...
TEMPLATE_TEST_CASE("Get bit", "[Bit operation]", int16_t, int32_t, int64_t, size_t, uint16_t,
                   uint32_t, uint64_t) {
  // 1011 0111 1010 1011
  TestType nValue = 0xB7AB;
...
TEMPLATE_TEST_CASE("Flip bit", "[Bit operation]", int16_t, int32_t, int64_t, size_t, uint16_t,
                   uint32_t, uint64_t) {
  // 1011 0111 1010 1011
  TestType nValue = 0xB7AB;
...
TEST_CASE("Get byte test - compile time", "[Byte operation]") {
  // 0xAB CD EF 01 23 45 67 89
...
TEST_CASE("Set byte test - compile time", "[Byte operation]") {
  // 0xAB CD EF 01 23 45 67 89
